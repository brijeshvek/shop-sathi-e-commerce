    ...
    <div className="space-y-8">
      ...
      {analyticsLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          <StatCard icon={TrendingUp} label="Total Revenue" value={stats ? formatCurrency(stats.totalRevenue) : '₹0'} color="bg-green-500" sub="From all your orders" />
          <StatCard icon={ShoppingBag} label="Total Orders" value={stats?.totalOrders ?? 0} color="bg-blue-500" sub="Orders with your products" />
          <StatCard icon={Package} label="Active Products" value={stats?.totalProducts ?? 0} color="bg-violet-500" sub="Listed in catalog" />
          <StatCard icon={Clock} label="Pending Orders" value={stats?.pendingOrders ?? 0} color="bg-orange-500" sub="Awaiting processing" />
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
            ...
            <Link to="/products" className="text-violet-600 text-xs font-semibold hover:underline flex items-center gap-1">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
            ...
            <Link to="/orders" className="text-violet-600 text-xs font-semibold hover:underline flex items-center gap-1">
              View all <ArrowRight size={12} />
            </Link>
          </div>
          {ordersLoading ? (
...
export const DashboardPage = () => {
  ...
  return isSeller ? <SellerDashboard /> : <AdminDashboard />
}
