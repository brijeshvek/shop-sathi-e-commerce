      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <nav aria-label="Help links">
            <h4 className="text-lg font-bold text-white mb-6 uppercase tracking-wider text-sm">Help & Support</h4>
            <ul className="space-y-3 text-sm">
          ...
          <nav aria-label="Top categories">
            <h4 className="text-lg font-bold text-white mb-6 uppercase tracking-wider text-sm">Shop</h4>
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/products" className="text-gray-400 hover:text-primary-400 hover:translate-x-1 inline-block transition-all font-semibold text-white">All Products &rarr;</Link></li>
            </ul>
          </nav>
