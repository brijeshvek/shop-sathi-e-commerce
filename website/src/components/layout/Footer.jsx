    ...
    <footer className="bg-gray-900 text-gray-300 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Brand Info */}
          <div>
            <h3 className="text-2xl font-bold text-white font-heading tracking-tight mb-4 flex items-center gap-2">
              <svg className="w-6 h-6 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
              Shop Shathi
            </h3>
            <p className="text-gray-400 text-sm mb-6">
              Everything you need, delivered right to your doorstep. The best products at the best prices.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/category/health-beauty" className="hover:text-white transition-colors">Health & Beauty</Link></li>
            ...
            <form className="flex flex-col space-y-2">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-gray-800 text-white rounded-lg py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-primary-500"
                  required
                />
              </div>
              <button 
