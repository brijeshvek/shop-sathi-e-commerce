...
export function BestSellers() {
  ...
  if (isLoading) {
    return (
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-busy="true" aria-label="Loading best sellers">
  ...
  return (
    <section className="py-8 sm:py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-gray-100 dark:border-gray-800" aria-label="Best sellers">
          ...
          <motion.div 
            ...
            className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6 mb-8 sm:mb-12 auto-rows-fr"
          >
            {products.map((product) => (
              ...
              >
                <Link href={`/products/${product.slug || product._id}`} className="relative aspect-square overflow-hidden bg-gray-50">
                  {product.images?.[0] ? (
                    <Image 
                ...
                <div className="p-3 sm:p-4 flex flex-col flex-grow min-h-[120px]">
