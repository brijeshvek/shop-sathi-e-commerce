...
export function BestSellers() {
  ...
  return (
    <section className="py-8 sm:py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-gray-100 dark:border-gray-850" aria-label="Best sellers">
      ...
      <div className="pt-4 sm:pt-6 border-t border-gray-100 dark:border-gray-800">
        ...
        <div className="flex overflow-x-auto space-x-3 sm:space-x-4 pb-4 scrollbar-none scroll-smooth" role="list" aria-label="Popular brands">
          {BRANDS.map(brand => (
            <Link 
              key={brand.name}
